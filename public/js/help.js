...
.controller('HelpController', function($scope) {
    ...
    $scope.faqs = [
        // Common Commands
        { category: 'common', question: "What does 'restartko' do?", answer: "The <b>'restartko'</b> command restarts Kolibri, ensuring it runs smoothly. Kolibri should be operational again within 2 minutes." },
        { category: 'common', question: "What does 'monthend' do?", answer: "Input the command <b>‘monthend 02-24’</b>; where, in this instance, <i>'02'</i> represents the month (February) and <i>‘24’</i> is the year (2024). The month-end process occurs on the 15th and the last day of every month. If the 15th falls on a Saturday, submission should be conducted on the preceding Friday, adhering to the same protocol for the month-end date." },
        { category: 'common', question: "What does 'make_quiz' do?", answer: "When you use the <b>‘make_quiz’</b> command it will refresh previously created quizzes." },
        { category: 'common', question: "What does 'assign_learners' do?", answer: "The <b>'assign_learners'</b> command assigns learners to their correct groups in Kolibri." },
        { category: 'common', question: "What does the 'shutdown' command do?", answer: "The <b>'shutdown'</b> command safely powers down the session laptop, ensuring that a backup is made before the laptop shuts off." },
        ...
        { category: 'hardware', question: "What should I do if the router is not working?", answer: "Ensure the router is properly connected to the power source and the session laptop. If it's still not working, restart the router and check the cables. If the issue persists, create a ticket on Freshdesk." },
        ...
        { category: 'software', question: "What should I do if I experience slow performance in Kolibri?", answer: "If Kolibri is slow, you can try restarting the laptop or tablet. If the issue persists, use the <b>'restartko'</b> command to reset Kolibri and restore its performance. If the issue persists, create a ticket on Freshdesk." },
    ];
