...
.controller('HelpController', function($scope) {
    ...
    $scope.faqs = [
        ...
        // Hardware
        { category: 'hardware', question: "How can i fix a multinationing tablet?", answer: "Try restarting the tablet. If the issue persists, perform a factory reset by navigating to the <b>'Backup and Reset'</b> option under <b>'Settings'</b> and selecting <b>'Factory Data Reset'</b>. If the issue persists, create a ticket on Freshdesk." },
